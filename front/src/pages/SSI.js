    ...
    return (
        <div className="App" >
            <BGContainer style={{display:"block", height:"100%"}}>
                ...
                <Web3text>
                    <SSItext2 style={{fontWeight: "700"}}> Before explain Web 3.0 </SSItext2>
                    {/* <SSItext3>
                    ...
                    <SSItext2> What is Web 1.0? </SSItext2>
                    <SSItext3>
                    ...
                    <SSItext2> What is Web 2.0? </SSItext2>
                    <SSItext3>
                    ...
                    <SSItext2>Problems with Web 2.0</SSItext2>
                    <SSItext3>
                    ...
                    <SSItext2>What is Web 3.0?</SSItext2>
                    <SSItext3>
                        It is a next-generation network structure in which all data and information are decentralized.
                        Blockchain-based Web 3.0 has emerged as a way to solve the Web2.0 problems.
